...
# The following three imports are not implemented in pytorch yet
...
class BaseModel:
    ...
    def train(self, n_iters_print: int = 100):
        """ Train the model
        :param n_iters_print: number of iterations before printing information in screen
        """
        n_iters_print = 100  # Print information every 100 iterations...otherwise screen would be a mess
    ...
    def evaluation(self):
        ...
        # TODO: migrate this code from tensorflow to pytorch
